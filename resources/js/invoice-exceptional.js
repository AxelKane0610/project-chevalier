...
document.addEventListener('DOMContentLoaded', function () {
    ...
    initAjaxTable({
        ...
        wrapper: 'all-invoice-exceptional-tickets-container',

        container: '#all-invoice-exception-tickets-table-container',

        url: '/invoice-exceptional-menu/filter-all-tickets'
