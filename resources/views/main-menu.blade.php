...
<div class="container-fluid py-4">
    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 row-cols-xl-5 g-4 d-flex flex-grow-1 justify-content-center align-items-center overflow-auto">
        ...
        @if(auth()->user()->hasRole('ROLE_SUPER_ADMIN') || auth()->user()->hasRole('ROLE_HPS_WAREHOUSE_ADMIN') || auth()->user()->hasRole('ROLE_HPS_WAREHOUSE_USER') )
            <div class="main-menu col" style="width: 300px">
                <a href="{{ url('/hps-warehouse-menu') }}"
                class="text-decoration-none">
                    ...
                    <div class="card h-100 shadow-lg border-0 rounded-5">
                        ...
                        <div class="card-body d-flex flex-column text-center">
                            ...
                            <div class="ticket-img-description">
                                <img src="{{ asset('imgs/hps_warehouse_image.png') }}"
                                    class="img-fluid"
                                    alt="">
                            </div>
