...
class ThermalEventExceptionalTicketsController extends Controller
{
    ...
    public function Show_Thermal_Event_Ticket_Details($id){
        $ticket = Thermal_Event_Exceptional_Tickets_Model::with(['user_owner', 'active_attachments','ticket_tracking_info','ticket_comments.attachments', 'ticket_comments.user'])->findOrFail($id);
